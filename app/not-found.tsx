...
export default function notFound() {
  return(
    <div className="flex justify-center items-center flex-col w-min p-6">
      ...
      <h2 className='text-2xl mb-3 md:text-5xl font-mono text-slate-800'>PAGE NOT FOUND</h2>
      <p className='text-center text-sm md:text-base mb-5 font-mono text-slate-800'>This page does not exist or has been moved. <br /> Try returning back to the homepage.</p>
